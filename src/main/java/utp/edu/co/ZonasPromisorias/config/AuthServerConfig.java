    ...
    public class CustomTokenConverter extends JwtAccessTokenConverter {
        ...
        public OAuth2AccessToken enhance(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
            ...
            if (authentication.getUserAuthentication() != null && authentication.getPrincipal() instanceof User) {
                ...
                ProductorEntity productor = repository.findByNombreUsuario(user.getUsername());
                additionalInfo.put("user_id", productor.getNitProductor());
                additionalInfo.put("name", productor.getNombreProductor());
                additionalInfo.put("latsName", productor.getApellidosProductor());
            }
